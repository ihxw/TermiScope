  ...
  static ThemeData get dark {
    return ThemeData.dark(useMaterial3: false).copyWith(
      ...
      textTheme: ThemeData.dark().textTheme.copyWith(
            ...
            bodyMedium: const TextStyle(fontSize: 12, height: 1.6667),
            bodySmall: const TextStyle(fontSize: 11, height: 1.6667),
            titleMedium:
                const TextStyle(fontSize: 14, fontWeight: FontWeight.w600),
            labelLarge: const TextStyle(fontSize: 12, height: 1.6667),
            labelMedium: const TextStyle(fontSize: 11, height: 1.6667),
          ),
  ...
  static ThemeData get light {
    return ThemeData.light(useMaterial3: false).copyWith(
      ...
      textTheme: ThemeData.light().textTheme.copyWith(
            bodyLarge:
                const TextStyle(fontSize: 14, height: 1.5, color: lightText),
            bodyMedium:
                const TextStyle(fontSize: 12, height: 1.6667, color: lightText),
            bodySmall:
                const TextStyle(fontSize: 11, height: 1.6667, color: mutedText),
