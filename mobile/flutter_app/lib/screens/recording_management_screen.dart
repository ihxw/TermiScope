    ...
    showDialog(
        ...
        builder: (dialogContext) => AntdModal(
              title: Row(children: [
                ...
                Expanded(
                    child: Text(rec['filename'] ?? 'Playback',
              ...
              : _recordings.isEmpty
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        final sz = rec['size'] != null
                            ? _fmtSize(rec['size'] as int)
                            : '-';
                        return AntdCard(
                            child: ListTile(
                          leading: Container(
                              ...
                              height: 40,
                              decoration: BoxDecoration(
                                  color: AntdTokens.primary.withAlpha(25),
                                  borderRadius: BorderRadius.circular(8)),
                              child: const Icon(Icons.videocam,
                                  color: AntdTokens.primary)),
                          title: Text(rec['filename'] ?? 'recording.cast',
                              style:
