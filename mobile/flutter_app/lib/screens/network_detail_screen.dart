...
class _NetworkDetailScreenState extends State<NetworkDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final isSettingsMode = widget.initialTab != 'connectivity';
    final state = context.watch<AppState>();
    final connected =
        state.monitorData[widget.hostId.toString()]?.isNotEmpty == true;
              ...
              child: SizedBox(
                ...
                child: Row(
                  children: [
                    ...
                    AntdTag(
                      color: connected ? AntdTokens.primary : AntdTokens.error,
                      label: connected ? '已连接' : '已断开',
                    ),
                  ],
                ),
              ),
