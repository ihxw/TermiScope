        ...
        return LayoutBuilder(
          builder: (context, constraints) {
            final crossAxisCount =
                Responsive.crossAxisCountFromWidth(constraints.maxWidth);
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final hostType = host.hostType.toLowerCase();
                if (hostType.contains('windows')) {
                  icon = Icons.desktop_windows;
                } else if (hostType.contains('monitor')) {
                  icon = Icons.monitor_heart;
                } else if (hostType.contains('sftp')) {
                  icon = Icons.folder;
                }

                return Card(
                  child: InkWell(
                    onTap: () => state.addTerminal(host),
                    child: Padding(
                        ...
                        children: [
                          Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                Icon(icon,
                                    color: const Color(0xFF1890FF), size: 22),
                                if (isOnline)
                                  Positioned(
                                    right: 6,
                                    top: 6,
