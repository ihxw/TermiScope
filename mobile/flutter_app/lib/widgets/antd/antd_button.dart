...
class _AntdButtonState extends State<AntdButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final mainColor = widget.danger ? AntdTokens.error : AntdTokens.primary;
    ...
    switch (widget.type) {
      ...
      case AntdButtonType.defaultType:
        ...
        border =
            widget.danger ? AntdTokens.error : AntdTokens.borderColor(context);
        if (_hover && !disabled) {
          fg = mainColor;
          border = mainColor;
        }
      ...
      case AntdButtonType.link:
        ...
        fg = _hover && !disabled
            ? (widget.danger ? AntdTokens.error : AntdTokens.primaryHover)
