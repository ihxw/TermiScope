...
class AntdUploadProgressDock extends StatelessWidget {
  ...
  Widget _statusIcon(AntdUploadStatus status, BuildContext context) {
    return switch (status) {
      AntdUploadStatus.success => const Icon(Icons.check_circle,
          size: 14, color: AntdTokens.success),
      AntdUploadStatus.failed => const Icon(Icons.error,
          size: 14, color: AntdTokens.error),
      ...
      AntdUploadStatus.uploading => SizedBox(
          ...
          child: CircularProgressIndicator(
            strokeWidth: 1.5,
            valueColor:
                const AlwaysStoppedAnimation<Color>(AntdTokens.primary),
          ),
        ),
    };
  }
