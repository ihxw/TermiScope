...
func (m *stubManager) UpdateRule(_ int, _ AddRuleRequest) error {
	return fmt.Errorf("firewall management is not supported on this platform")
}
...
func (m *stubManager) UpdatePortForward(_ int, _ AddPortForwardRequest) error {
	return fmt.Errorf("firewall management is not supported on this platform")
}
...
func (m *stubManager) KVMCompatibility() (KVMCompatStatus, error) {
	return KVMCompatStatus{}, nil
}

func (m *stubManager) EnsureKVMCompatibility() error {
	return nil
}
