...
// verifyMonitorSecret checks host_id + secret (query or Bearer). Used by public agent/install routes.
...
// extractMonitorSecret reads secret from Bearer header or ?secret= (legacy install links).
