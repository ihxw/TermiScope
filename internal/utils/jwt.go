...
func GenerateToken(userID uint, username, role, tokenType string, expiration time.Duration, secret string) (string, error) {
	return GenerateTokenWithVersion(userID, username, role, tokenType, 0, expiration, secret)
}

// GenerateTokenWithVersion generates a token bound to the user's current session version.
func GenerateTokenWithVersion(userID uint, username, role, tokenType string, tokenVersion uint, expiration time.Duration, secret string) (string, error) {
