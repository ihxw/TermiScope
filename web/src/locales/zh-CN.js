export default {
    ...
    monitor: {
        ...
        installCommandTitle: '一键安装监控代理',
        manualInstallNotice: '在目标主机上执行以下命令即可自动安装监控代理，支持自动识别系统和架构。',
        installSupport: '支持 Linux (systemd/procd/sysv/upstart), macOS (LaunchAgent) 和 FreeBSD',
        installNote: '注意：请使用 root 或具有 sudo 权限的用户执行命令。安装成功后，Agent 会自动启动并连接服务器。',
        manualUninstall: '手动卸载',
        uninstallCommandTitle: '手动卸载监控代理',
        manualUninstallNotice: '在目标主机上执行以下命令即可卸载监控代理和相关服务。',
        uninstallSupport: '支持 Linux, macOS 和 FreeBSD',
