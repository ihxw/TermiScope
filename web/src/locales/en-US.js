export default {
    ...
    host: {
        ...
        monitorOnlyNoConnect: 'Monitor-only hosts cannot be connected via SSH',
        ...
        billingSemiannually: 'Semiannually',
        billingAnnually: 'Annually',
        billingBiennial: 'Biennial (2 Years)',
        billingTriennial: 'Triennial (3 Years)',
        billing4Year: '4 Years',
        billing5Year: '5 Years',
        billing6Year: '6 Years',
        billing7Year: '7 Years',
        billing8Year: '8 Years',
        billing9Year: '9 Years',
        billing10Year: '10 Years',
        ...
        placeholderBillingAmount: 'Enter billing amount',
        showDeleted: 'Show Deleted',
        hideDeleted: 'Hide Deleted',
        type: 'Type',
        controlAndMonitor: 'Control+Monitor',
        controlAndMonitorDesc: 'SSH Control + Monitor Agent (Remote connection and monitoring)',
        monitorOnlyDesc: 'Monitor Agent only (Monitoring only, no SSH connection)',
    ...
    system: {
        ...
        restoreUploading: 'Uploading file... {percent}%',
        restoreProcessing: 'Restoring database, please wait...',
        restoreRestarting: 'Restore successful, restarting server...',
    ...
    monitor: {
        ...
        total: 'Total',
        usage: 'Usage',
        batchDeploy: 'Batch Deploy Monitor',
        batchDeployConfirm: 'Ready to deploy monitor to {count} hosts',
        batchTrafficNotify: 'Batch Traffic Warning',
        batchOfflineNotify: 'Batch Online/Offline Notification',
        enable: 'Enable',
        disable: 'Disable',
        batchUpdateSuccess: 'Batch update successful',
        batchUpdatePartial: 'Update completed: {success} success, {fail} failed',
        ...
        noValidHostsForDeploy: 'All selected hosts are monitor-only type, cannot deploy',
        skippedMonitorOnly: 'Skipped {count} monitor-only host(s)',
        installCommandTitle: 'Manual Agent Installation',
        manualInstallNotice: 'Execute the following command with root/administrator privileges on the target host',
        installSupport: 'Supported: Ubuntu 20.04+, Debian 11+, CentOS 7+, Fedora 30+, Arch Linux',
        windowsInstallSupport: 'Supported: Windows Server 2016+, Windows 10+ (Run PowerShell as Administrator)',
        installNote: 'Note: Ensure the host can access this server\'s IP and port. Monitor data will be reported automatically after installation.',
    ...
    sftp: {
        ...
        deleteSelectedConfirm: 'Are you sure to delete {count} selected items? This action cannot be undone!',
