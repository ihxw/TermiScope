            ...
            <a-spin :spinning="firewallLoading">
              ...
              <a-tabs v-model:activeKey="firewallTab">
                ...
                <a-tab-pane key="forward" :tab="t('system.firewallTabForward')">
                  ...
                  <a-space wrap style="margin-bottom: 12px">
                    <a-tooltip
                      :title="addPortForwardDisabledHint"
                      :overlay-style="addPortForwardDisabledHint ? {} : { display: 'none' }"
                    >
                      <a-button
                        type="dashed"
                  ...
                  <a-alert
                    v-if="!canAddPortForward && firewallStatus.available"
                    type="warning"
                    show-icon
                    style="margin-bottom: 12px"
                    :message="t('system.firewallPortForwardDisabledTitle')"
                    :description="t('system.firewallPortForwardDisabledDesc')"
                  />
                  <a-table
...
const addPortForwardDisabledHint = computed(() => {
  if (!firewallStatus.available) {
    return t('system.firewallUnavailable')
  }
  if (!canAddPortForward.value) {
    return t('system.firewallPortForwardDisabledTitle')
  }
  return ''
})
