<template>
  <div class="terminal-page">
    <a-card :bordered="false" class="terminal-card">
      ...
      <div class="terminal-container-inner">
        <a-tabs
...
<script setup>
import { ref, provide, watch, onMounted, onActivated, createVNode } from 'vue'
...
watch(activeTerminalKey, (id) => {
  if (id) {
    sshStore.setCurrentTerminal(id)
  }
}, { immediate: true })
...
:deep(.terminal-tabs .ant-tabs-content-holder),
:deep(.terminal-tabs .ant-tabs-content) {
  min-width: 0;
  max-width: 100%;
  overflow: hidden;
}
