    ...
    >
      <a-form layout="vertical">
        <a-form-item :label="t('common.name')" required>
          <a-input v-model:value="templateForm.name" :placeholder="t('network.templateNamePlaceholder')" />
        </a-form-item>
        ...
        <a-form-item :label="t('network.targetAddress')" required>
          <a-input v-model:value="templateForm.target" :placeholder="t('network.templateTargetPlaceholder')" />
        </a-form-item>
        ...
        <a-form-item :label="t('common.label')">
          <a-input v-model:value="templateForm.label" :placeholder="t('network.templateLabelPlaceholder')" />
        </a-form-item>
          ...
          <div class="color-picker">
            <div class="color-presets">
              <button
                ...
                :title="color"
                :aria-label="t('network.selectTemplateColor', { color })"
...
const openApplyModal = async (tmpl) => {
  ...
  try {
    ...
    message.error(t('network.loadAssignmentsFailed'))
  }
}
