    ...
    <a-card :bordered="false">
      <a-tabs v-model:activeKey="activeTab">
        <a-tab-pane key="ssh" :tab="$t('history.sshTitle')">
          <DataLoadError
            v-if="sshLoadError"
            :message="t('history.loadSshFailed')"
            :loading="sshLoading"
            @retry="loadSSHLogs"
          />
          <a-table
        ...
        <a-tab-pane key="web" :tab="$t('history.webTitle')">
          <DataLoadError
            v-if="webLoadError"
            :message="t('history.loadWebFailed')"
            :loading="webLoading"
            @retry="loadWebLogs"
          />
          <a-table
        ...
        <a-tab-pane key="server" :tab="$t('history.serverLogsTitle')">
          ...
          <DataLoadError
            v-if="serverLogLoadError"
            :message="t('history.loadServerLogsFailed')"
            :loading="serverLogLoading"
            @retry="loadServerLogs"
          />
          <template v-else>
            <a-alert
...
const serverLogLoadError = ref(false)
...
const loadServerLogs = async () => {
  ...
  serverLogLoadError.value = false
  try {
