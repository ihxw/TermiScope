...
/** Batch latency stats for all tasks on a host (one HTTP round-trip). */
export function getHostLatencyStats(hostId, range) {
    return api.get(`/ssh-hosts/${hostId}/network/latency-stats`, {
        params: { range }
    })
}
