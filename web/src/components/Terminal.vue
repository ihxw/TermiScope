...
const initTerminal = () => {
  ...
  termElement.addEventListener('touchstart', (e) => touchToMouse(e, 'mousedown'), { passive: false })
  termElement.addEventListener('touchmove', (e) => touchToMouse(e, 'mousemove'), { passive: false })
  termElement.addEventListener('touchend', (e) => touchToMouse(e, 'mouseup'), { passive: false })
