...
const fallbackIcon = computed(() => {
  ...
  if (o.includes('linux') || o.includes('ubuntu') || o.includes('debian') || o.includes('centos') ||
    o.includes('fedora') || o.includes('arch') || o.includes('alpine') ||
    o.includes('suse') || o.includes('raspbian') || o.includes('raspberry'))
